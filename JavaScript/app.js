// infasor codul cu un eveniment 🢣 face codul disponibil in momentul in care toate elementele au fost incarcate in DOM
document.addEventListener("DOMContentLoaded", () => {
  ...
  function gameImagesAnimation(picks) {
    ...
    for (let img of gameImages) {
      ...
      if (img.classList.contains("move-left"))
        img.classList.remove("move-left");
